...
- `domain` may import `kernel`, `prompts`, and `lib`; domain CLI files may import app CLI/bootstrap helpers
...
- `src/panda/tools/*.ts` leaf files are implementation detail; use `panda` or `panda/panda` instead
