...
describe("email recipient allow-rules migration", () => {
  it("hard-cuts legacy rows to typed address rules before exposing the new view", async () => {
    ...
    expect(ids.slice(12, 17)).toEqual([
      "0013_scheduled_commands", "0014_email_recipient_allow_rules",
      "0015_agent_live_voice", "0016_whatsapp_call_controls", "0017_channel_action_expiry",
    ]);
