...
describe("database migration boundary", () => {
  ...
  it("keeps schema DDL behind an explicit migration-owned allowlist", async () => {
    ...
    const allowed = new Set([
      ...
      "app/database/migrations/0020-channel-receipt-ownership.ts",
      "app/database/migrations/0021-environment-operation-ownership.ts",
      "app/database/migrations/0022-watch-claim-ownership.ts",
      "app/database/migrations/0023-gateway-upload-reservations.ts",
      "app/database/migrations/0024-gateway-input-receipts.ts",
      "app/database/migrations/0025-runtime-error-summary.ts",
