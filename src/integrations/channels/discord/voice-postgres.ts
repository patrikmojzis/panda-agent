...
export async function ensureDiscordVoiceControlSchema(pool: PgQueryable): Promise<void> {
...
export class DiscordVoiceControlRepo {
  ...
  ensureSchema(): Promise<void> { return ensureDiscordVoiceControlSchema(this.pool); }
