...
type WebResearchProgressStatus = "researching" | "formatting";
type WebResearchProgress = {
...
interface PerformWebResearchOptions {
  apiKey?: string;
...
interface PerformWebResearchResult {
  query: string;
  provider: "openai";
  model: string;
...
/** Runs an OpenAI hosted-web-search request and normalizes citations/sources for Panda tools. */
