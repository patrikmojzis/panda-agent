...
export function looksLikeSilentCommand(command: string): boolean {
...
export function applyPersistedEnv(shellSession: PandaShellSession | null, entries: PersistedEnvEntry[]): string[] {
