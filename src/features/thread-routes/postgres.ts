...
import type {ThreadRouteStore} from "./store.js";
...
export interface PostgresThreadRouteStoreOptions {
  pool: PgPoolLike;
  tablePrefix?: string;
}
...
export class PostgresThreadRouteStore implements ThreadRouteStore {
  private readonly pool: PgPoolLike;
  private readonly tables: ThreadRouteTableNames;

  constructor(options: PostgresThreadRouteStoreOptions) {
