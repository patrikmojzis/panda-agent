...
import {toMillis} from "../thread-runtime/postgres-shared.js";
import {buildPandaDaemonStateTableNames, type PandaDaemonStateTableNames} from "./postgres-shared.js";
import type {PandaDaemonStateStore} from "./store.js";
...
export interface PostgresPandaDaemonStateStoreOptions {
  pool: PgQueryable;
  tablePrefix?: string;
}
...
export class PostgresPandaDaemonStateStore implements PandaDaemonStateStore {
  private readonly pool: PgQueryable;
  private readonly tables: PandaDaemonStateTableNames;

  constructor(options: PostgresPandaDaemonStateStoreOptions) {
