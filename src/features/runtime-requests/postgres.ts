...
export interface PostgresPandaRuntimeRequestStoreOptions {
  pool: PgPoolLike;
  tablePrefix?: string;
}
...
export class PostgresPandaRuntimeRequestStore implements PandaRuntimeRequestStore {
  private readonly pool: PgPoolLike;
  private readonly tables: PandaRuntimeRequestTableNames;
  private readonly notificationChannel: string;

  constructor(options: PostgresPandaRuntimeRequestStoreOptions) {
