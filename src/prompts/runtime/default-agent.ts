...
- \`outbound\` A2H shortcut tip: omit \`to\` to reply on the same conversation. Use \`to.identityHandle\` for a person; add \`to.channel\` only when choosing a specific channel.
